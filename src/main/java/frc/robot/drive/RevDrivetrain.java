...
import static frc.robot.Constants.kDriveWheelRadiusMeters;
import static frc.robot.Constants.kGearRatio;
import static frc.robot.Constants.kLeftFrontPort;
import static frc.robot.Constants.kLeftRearPort;
import static frc.robot.Constants.kRightFrontPort;
import static frc.robot.Constants.kRightRearPort;
...
import frc.robot.Gains.driveFeedforward;
import frc.robot.Gains.leftDrive;
import frc.robot.Gains.rightDrive;
...
public class RevDrivetrain extends SubsystemBase {
  ...
  public PIDController gyroController = new PIDController(0.1, 0, 0);
  ...
  private SimpleMotorFeedforward feedforward = new SimpleMotorFeedforward(driveFeedforward.ks, driveFeedforward.kv,
      driveFeedforward.ka);

  private PIDController leftDrivePID = new PIDController(leftDrive.kP, leftDrive.kI, leftDrive.kD);

  private PIDController rightDrivePID = new PIDController(rightDrive.kP, rightDrive.kI, rightDrive.kD);
